...
public interface IDustDao {
	...
	// 保存一条记录
	public abstract void save(Dust dust);

	// 保存一条记录
	public abstract Integer savereturn(Dust dust);
	...
	// 根据hql语句来查询所有记录
	public abstract List<Dust> queryList(String queryString);

	// 根据hql、条件值查询某些记录
	public abstract List<Dust> getObjectsByCondition(String queryString,
			Object[] p);
	...
	// 根据hql语句、条件、值来查询一条记录
	public abstract Dust queryByNamedParam(String queryString,
			String[] paramNames, Object[] values);

	// 根据hql语句、条件值来查询是否存在该记录
	public abstract boolean checkDustExistsWithName(String queryString,
			Object[] p);

	// 根据hql批量修改
	public abstract int updateDustByhql(String queryString, Object[] p);
